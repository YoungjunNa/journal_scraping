---
title: 'Animal nutrition journal report: January 2018'
...
## 2.1. Review
```{r echo=TRUE}
results <- readxl::read_excel("journal_result_2018_1.xlsx")
...
wc <- readxl::read_excel("journal_result_2018_1.xlsx")
...
wordcloud2(wc_data, max.words = Inf, min.freq = 1, random.order = FALSE, rot.per = 0.1, colors = brewer.pal(8, "Dark2"), figPath = "E:/GitHub/journal_scraping/pig.jpeg") 
