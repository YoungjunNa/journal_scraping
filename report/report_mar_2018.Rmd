---
title: 'Animal nutrition journal report: March 2018'
...
options(warn=-1)
pacman::p_load("knitr","ggplot2","tm","SnowballC","wordcloud","RcolorBrewer","stringr","dplyr","plotly")
...
# 1. List of journals
```{r echo=TRUE}
journal_list <- readxl::read_excel("journal_result_2018_3.xlsx")
...
## 2.1. Review
```{r echo=TRUE}
results <- readxl::read_excel("journal_result_2018_3.xlsx")
...
wc <- readxl::read_excel("journal_result_2018_3.xlsx")
